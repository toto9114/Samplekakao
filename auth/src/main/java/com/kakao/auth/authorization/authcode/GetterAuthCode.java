...
public class GetterAuthCode extends Authorizer {
    ...
    private boolean requestWebviewAuth() {
        ...
        try {
            ...
            new KakaoWebViewDialog(callerActivity, uri.toString(), authCodeRequest.getExtraHeaders(), KakaoSDK.getAdapter().getSessionConfig().isUsingWebviewTimer(), listener).show();
        } catch (Throwable t) {
