        ...
        if (userProfile != null) {
            ...
            headerView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    requestSendMessage(type, new MessageSendable() {
                    ...
                    }, makeMessageBuilder(type, userProfile.getNickname()));
                }
            });
        }
    }
    ...
    private void requestSendMessage(MSG_TYPE type, MessageSendable friendInfo, KakaoTalkMessageBuilder builder) {
        KakaoTalkService.requestSendMessage(new TalkResponseCallback<Boolean>() {
            ...
            public void onNotSignedUp() {
                KakaoToast.makeToast(self, "onNotSignedUp : " + "User Not Registed App", Toast.LENGTH_LONG).show();
            }
